...
|     3     | 07 Jun – 20 Jun | Elaboración  | Game Design Document 70% <br> Diagrama CU completo <br> Casos de Uso Especificados                                                                                  | `docs/game-design/gdd.md`, `docs/requisitos/casos-de-uso/modelo-casos-uso.md`, `docs/diagramas/diagrama-casos-de-uso.puml`<br>`docs/requisitos/casos-de-uso/CU-XX-####-especificacion.md`<br>                                                                             |
