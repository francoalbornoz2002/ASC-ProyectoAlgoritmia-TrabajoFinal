...
| ----------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Descripción | Desarrollar un tablero de progreso y reportes con filtros para docentes que muestre el progreso individual y grupal de los alumnos pudiendo así identificar a los alumnos atrasados y con poca actividad en la plataforma, asi como tambien las dificultades y el riesgo académico de cada uno |
| Estabilidad | Alta                                                                                                                                                                                                                                                                                           |
| Comentarios |                                                                                                                                                                                                                                                                                                |
